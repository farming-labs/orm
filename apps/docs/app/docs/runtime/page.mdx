...
detection layer to prepare direct SQL, Prisma, TypeORM, MongoDB, Mongoose,
Drizzle, and Kysely runtimes without inventing a separate config surface.
...
Sequelize, direct SQL, MongoDB, or Mongoose.
