...
detection layer to prepare direct SQL, Prisma, TypeORM, Sequelize, MongoDB,
Mongoose, Firestore, DynamoDB, Unstorage, Drizzle, and Kysely runtimes without
...
Sequelize, direct SQL, Firestore, DynamoDB, Unstorage, MongoDB, or Mongoose.
