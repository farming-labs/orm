...
This works well for string, boolean, and integer fields today. JSON defaults can
still be applied by runtime drivers, but generated schema support is more
limited and should be treated as backend-specific for now.
