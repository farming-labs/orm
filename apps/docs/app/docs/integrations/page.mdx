---
title: "Integrations"
description: "How Farming Labs ORM fits into Prisma, Drizzle, Kysely, MikroORM, TypeORM, Sequelize, Cloudflare D1, Redis / Upstash, SQL-first, Supabase, Firestore, DynamoDB, Unstorage, and MongoDB-oriented workflows."
order: 6
icon: package
---
...
- Firestore and Unstorage do not have SQL-style schema push, so setup helpers
  are intentionally no-op there
