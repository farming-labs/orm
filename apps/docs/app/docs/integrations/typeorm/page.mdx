...
The TypeORM package is verified against:

- SQL.js-backed SQLite smoke coverage for bootstrap and runtime creation
- PostgreSQL through a real local TypeORM `DataSource`
- MySQL through a real local TypeORM `DataSource`
