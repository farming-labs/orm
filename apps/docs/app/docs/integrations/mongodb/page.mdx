...
<HoverLink
  ...
  description="Learn how MongoDB sessions and transactions work in the official Node.js driver, including transaction boundaries and session lifecycles."
...
<HoverLink
  ...
  description="See how Mongoose wraps MongoDB sessions for transactions, including session propagation and transactional document operations."
