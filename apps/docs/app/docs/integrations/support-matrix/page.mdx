...
MongoDB, Mongoose, Firestore, DynamoDB, Redis / Upstash Redis, and Unstorage
...
- MongoDB, Mongoose, Firestore, DynamoDB, Redis, and Unstorage keep numeric IDs manual-only
