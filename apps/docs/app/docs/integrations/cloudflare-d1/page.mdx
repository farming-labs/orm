...
- use setup helpers in local verification or CI when you want repeatable schema
  prep against a Miniflare-backed D1 binding
...
- local Miniflare-backed setup verification
...
- extremely large `bigint()` values beyond the JavaScript safe integer range
  should not be treated as precision-preserving round trips through D1

## Local verification

The repo verifies D1 locally through a Miniflare-backed integration suite.
